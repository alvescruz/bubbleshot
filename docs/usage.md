...
- ⭕ **Circle:** Perfect for highlighting icons or circular UI elements.
- ↗️ **Arrow:** Point specifically to what matters.
- 🔢 **Steps:** Click to place auto-incrementing numbers (1, 2, 3...) — great for tutorials!
- 💧 **Blur:** Obfuscate sensitive information (passwords, usernames).
- 🔤 **Text:** Add clear labels (press `Enter` to finish a text block).
- 🖱️ **Move:** Select and drag any existing shape to reposition it.
- 🗑️ **Clear All:** Wipe the canvas clean and start over.
